...
(diagram omitted in bundle: Orchestrator)

## Sample Code

Runnable, tested implementation: [`samples/coordination/orchestrator/`](sample code not bundled)
...
- *uses* **[Pipeline](pipeline.md)** — a linear orchestrator is a pipeline.
- *used-by* **[Checkpoint & Resume](checkpoint-resume.md)** — centralized state is what makes checkpointing natural.
