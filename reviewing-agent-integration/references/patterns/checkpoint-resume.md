...
Runnable implementation: [samples/python/resilience/checkpoint_resume.py](sample code not bundled)
...
- *used-by* [Orchestrator](orchestrator.md) — centralized state is what makes checkpointing natural.
- *used-by* [Magentic Orchestration](magentic.md) — the task ledger is a natural checkpoint boundary.
- *complements* [Pipeline](pipeline.md) — pipeline steps are natural checkpoint boundaries.
