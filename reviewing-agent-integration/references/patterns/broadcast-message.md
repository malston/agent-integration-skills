...
(diagram omitted in bundle: Broadcast Message — Agent A (Publisher) publishes to Agent B, C, and D simultaneously)

## Sample Code
Runnable implementation: [samples/python/messaging/broadcast_message.py](sample code not bundled)
...
- *used-by* [Scatter-Gather](scatter-gather.md) — scatter uses broadcast semantics to fan out.
