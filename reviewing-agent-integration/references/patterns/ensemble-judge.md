...
(diagram omitted in bundle: Ensemble Judge)

## Sample Code

Runnable, tested implementation: [`samples/evaluation/ensemble_judge/`](sample code not bundled)
...
- *specializes* **[Scatter-Gather](scatter-gather.md)** — Ensemble Judge is Scatter-Gather applied to evaluation.
- *uses* **[Dead Letter Agent](dead-letter-agent.md)** — the escalation target for split verdicts and rejections.
