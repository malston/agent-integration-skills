...
## Sample Code
Runnable implementation: [samples/python/coordination/mediator.py](sample code not bundled)
...
- *uses* [Agent Card Registry](agent-card-registry.md) — to discover and address the agents it mediates.
