...
## Sample Code
Runnable implementation: [samples/python/implementation/exception_handler_chain.py](sample code not bundled)
...
- *used-by* [Magentic Orchestration](magentic.md) — stall detection is a lightweight EHC (escalate after stall_limit consecutive non-progress rounds).
