...
(diagram omitted in bundle: Trust Boundary)

## Sample Code

Runnable, tested implementation: [`samples/security/trust_boundary/`](sample code not bundled)
...
- *uses* **[Agent Proxy](agent-proxy.md)** — the gateway tier is often implemented as a proxy.
